...
import it.unibo.sistemidigitali.exam.jhon_ai.Config.Feature;
...
public class RecommendationClient {
  ...
  public synchronized List<Result> recommend(List<MovieItem> selectedMovies) {
    Log.d("DOVEFAMAP?", selectedMovies.get(0).toString());
    Object[] inputs = preprocess(selectedMovies);
   // Log.d("DOVEFAMAP?",inputs[0].toString());
    ...
    //Log.d("DOVEFAMAP?",Arrays.stream(inputs).toString());
  //  Log.d("DOVEFAMAP?",outputs.toString());
